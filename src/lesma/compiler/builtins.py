...
def define_builtins(self):
    ...
    self.define('Dynamic_Array', str_struct)
    ...
    define_create_range(self, str_struct_ptr)
...
def create_dynamic_array_methods(self, array_type):
    array_ptr = self.search_scopes('{}_Array'.format(array_type))

    dynamic_array_init(self, array_ptr)
    dynamic_array_double_if_full(self, array_ptr)
    dynamic_array_append(self, array_ptr)
    dynamic_array_get(self, array_ptr)
    dynamic_array_set(self, array_ptr)
    dynamic_array_length(self, array_ptr)
    define_create_range(self, array_ptr)


def define_create_range(self, dyn_array_struct_ptr):
    ...
    builder.call(self.module.get_global('dyn_array_append'), [builder.load(array_ptr), builder.load(num_ptr)])
...
def dynamic_array_init(self, dyn_array_struct_ptr):
    # START
    dyn_array_init_type = ir.FunctionType(type_map[VOID], [dyn_array_struct_ptr])
    dyn_array_init = ir.Function(self.module, dyn_array_init_type, 'dyn_array_init')
...
def dynamic_array_double_if_full(self, dyn_array_struct_ptr):
    # START
...
def dynamic_array_append(self, dyn_array_struct_ptr):
    # START
    dyn_array_append_type = ir.FunctionType(type_map[VOID], [dyn_array_struct_ptr, type_map[INT]])
    dyn_array_append = ir.Function(self.module, dyn_array_append_type, 'dyn_array_append')
    ...
    # BODY
    builder.call(self.module.get_global('dyn_array_double_capacity_if_full'), [builder.load(array_ptr)])
...
def dynamic_array_get(self, dyn_array_struct_ptr):
    # START
    dyn_array_get_type = ir.FunctionType(type_map[INT], [dyn_array_struct_ptr, type_map[INT]])
    dyn_array_get = ir.Function(self.module, dyn_array_get_type, 'dyn_array_get')
...
def dynamic_array_set(self, dyn_array_struct_ptr):
    # START
    dyn_array_set_type = ir.FunctionType(type_map[VOID], [dyn_array_struct_ptr, type_map[INT], type_map[INT]])
    dyn_array_set = ir.Function(self.module, dyn_array_set_type, 'dyn_array_set')
...
def dynamic_array_length(self, dyn_array_struct_ptr):
    # START
    dyn_array_length_type = ir.FunctionType(type_map[INT], [dyn_array_struct_ptr])
    dyn_array_length = ir.Function(self.module, dyn_array_length_type, 'dyn_array_length')
...
def define_print(self, dyn_array_struct_ptr):
    # START
    ...
    # BODY
    builder.position_at_end(entry_block)
    length = builder.call(self.module.get_global('dyn_array_length'), [builder.load(array_ptr)])
    ...
    char = builder.call(self.module.get_global('dyn_array_get'), [builder.load(array_ptr), builder.load(position_ptr)])
...
def define_int_to_str(self, dyn_array_struct_ptr):
    # START
    ...
    builder.call(self.module.get_global('dyn_array_append'), [builder.load(array_ptr), char])
...
def define_bool_to_str(self, dyn_array_struct_ptr):
    # START
    ...
    dyn_array_append = self.module.get_global('dyn_array_append')
